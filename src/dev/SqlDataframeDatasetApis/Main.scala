package dev.SqlDataframeDatasetApis
  ...
  // Define the case classes for using in conjunction with DataFrames
	...
	def gettingStarted() {
	  // Creation of the list from where the RDD is going to be created
		val acTransList = Array("SB10001,1000", "SB10002,1200", "SB10003,8000", "SB10004,400", "SB10005,300", "SB10006,10000", 
		    "SB10007,500", "SB10008,56", "SB10009,30","SB10010,7000", "CR10001,7000", "SB10002,-10")
		...
		// Degug: print the internal of a dataset.
		acTransDF.foreach{row => 
		  print(row)
		}
		...
		print(sumAmountByMixing)

	}
	
	// PROGRAMING WITH DATAFRAME API
	// -----------------------------
